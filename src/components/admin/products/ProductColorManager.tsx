          ...
          >
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0">
              ...
              <select
                ...
                className="text-base lg:text-xs p-1.5 rounded-lg border border-neutral-200 bg-neutral-50 text-neutral-700 max-w-[130px] truncate"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-2 pt-2 border-t border-neutral-200/80">
        <div className="sm:col-span-4">
          <input
            ...
            className="w-full p-2.5 rounded-xl border border-neutral-200 text-base lg:text-sm bg-white"
          />
        </div>
        ...
        <div className="sm:col-span-4">
          <select
            ...
            className="w-full h-10 p-2 rounded-xl border border-neutral-200 text-base lg:text-sm bg-white"
          >
