...
export function AdminSettingsClient({ initialSettings }: AdminSettingsClientProps) {
  ...
  const [formData, setFormData] = useState<SettingsFormData>(() => {
    ...
    return {
      ...
      landlinePhone: initialSettings.landlinePhone ?? STORE_DEFAULTS.landlinePhone,
      secondaryPhone: initialSettings.secondaryPhone ?? STORE_DEFAULTS.secondaryPhone,
      whatsapp: initialSettings.whatsapp || STORE_DEFAULTS.whatsapp,
      supportWhatsapp: initialSettings.supportWhatsapp || initialSettings.whatsapp || STORE_DEFAULTS.supportWhatsapp,
      ...
      googleMapsUrl: initialSettings.googleMapsUrl ?? STORE_DEFAULTS.googleMapsUrl,
      telegramUrl: initialSettings.telegramUrl ?? STORE_DEFAULTS.telegramUrl,
