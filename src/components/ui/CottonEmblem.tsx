...
export function CottonEmblem({
  ...
  const primaryFill = isOutline ? "none" : isMonochrome ? "currentColor" : `url(#${gradientId})`;
  const highlightFill = isOutline ? "none" : isMonochrome ? "currentColor" : `url(#${highlightId})`;
  const strokeColor = isOutline ? "currentColor" : isMonochrome ? "currentColor" : "#8e6810";
  const outlineStrokeWidth = isOutline ? 1.2 : undefined;
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={highlightFill}
        fillOpacity={variant === "gold" ? "0.95" : isMonochrome ? "0.85" : undefined}
        stroke={isOutline ? strokeColor : undefined}
        strokeWidth={outlineStrokeWidth}
      />
      ...
      <circle
        ...
        cy="13.5"
        r="1.2"
        fill={isOutline ? "none" : strokeColor}
        stroke={isOutline ? strokeColor : undefined}
        strokeWidth={isOutline ? 0.8 : undefined}
        opacity={variant === "gold" ? 0.6 : isMonochrome ? 0.7 : 1}
      />
    </svg>
  );
}
