        ...
        <div className="space-y-4 text-sm">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 rounded-xl border text-base lg:text-sm transition focus:outline-none ${
                formErrors.fullName
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl border text-base lg:text-sm text-left transition focus:outline-none ${
        ...
        <div className="space-y-4 text-sm">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-xl border border-neutral-200 text-base lg:text-sm font-semibold focus:ring-2 focus:ring-amber-500 focus:outline-none bg-white cursor-pointer"
              >
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full px-4 py-3 rounded-xl border text-base lg:text-sm transition leading-relaxed focus:outline-none ${
                formErrors.address
                  ? "border-rose-400 bg-rose-50/30 focus:ring-2 focus:ring-rose-500"
                  : "border-neutral-200 focus:ring-2 focus:ring-amber-500"
              }`}
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-neutral-200 text-base lg:text-sm focus:ring-2 focus:ring-amber-500 focus:outline-none"
            />
          </div>
        </div>
      </Card>
