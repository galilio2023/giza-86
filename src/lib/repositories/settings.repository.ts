...
export class DrizzleSettingsRepository implements ISettingsRepository {
  ...
  private mapRowToItem(s: typeof storeSettings.$inferSelect): StoreSettingsItem {
    ...
    return {
      ...
      landlinePhone: s.landlinePhone ?? STORE_DEFAULTS.landlinePhone,
      secondaryPhone: s.secondaryPhone ?? STORE_DEFAULTS.secondaryPhone,
      supportWhatsapp: s.supportWhatsapp || s.whatsapp || STORE_DEFAULTS.supportWhatsapp,
      workingHours: s.workingHours || STORE_DEFAULTS.workingHours,
      googleMapsUrl: s.googleMapsUrl ?? STORE_DEFAULTS.googleMapsUrl,
      telegramUrl: s.telegramUrl ?? STORE_DEFAULTS.telegramUrl,
